        ...
        <View className="px-4">
          ...
          >
            <Pressable
              ...
              className="mb-3 flex-row items-center justify-between rounded-lg border border-outline-100 bg-background-0 p-3 transition-colors shadow-soft-1 active:bg-background-50"
            >
