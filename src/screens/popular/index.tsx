...
import { usePopularComics } from "./hooks/usePopularComics"
import { PopularParams } from "./repository"

const numColumns = 2

const PopularScreen = () => {
  const [filters, setFilters] = useState<PopularParams>({
    page: 1,
    type: "all",
    orderBy: "modified",
  })
  ...
  const { data, isLoading, hasMore, error, mutate } = usePopularComics(filters)
