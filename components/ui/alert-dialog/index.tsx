...
const alertDialogCloseButtonStyle = tva({
  base: 'group/alert-dialog-close-button z-10 rounded-sm p-2 data-[focus-visible=true]:bg-background-900 data-[focus-visible=true]:opacity-10 web:cursor-pointer outline-0',
});
